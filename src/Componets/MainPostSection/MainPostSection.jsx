  ...
  return (
    <div className="main-post-section mx-auto px-2">
      <div className="col top-header d-flex justify-content-between">
        ...
        <p className="min-btn2 d-lg-none" role="button">
        ...
        <ul className="list-unstyled d-none d-lg-flex">
          ...
          <li role="button">Artical</li>
          <li role="button">Event</li>
          <li role="button">Education</li>
          <li role="button">Job</li>
        </ul>
      ...
      <div className="col main-post">
        <div className="row">
          <div className="col-lg-8 poster-left">
            ...
            {/* just to complete the work soon */}
            <div className="post">
              <img
                className="w-100"
                src="https://i.ibb.co/yBTtKTb/post3.png"
                alt="post-img"
              />
            ...
            <div className="post">
              ...
              <div className="d-flex justify-content-between">
                ...
                <span
                  ...
                  className={`edit position-relative ${edit2 ? "editbg" : ""}`}
                >
                  <BiDotsHorizontal />
                  {edit2 && (
                    <ul className="list-unstyled position-absolute">
                ...
                <div className="list">
                  <div className="d-flex justify-content-between align-items-center">
                    <div>
                      <img
                        height={36}
                        src="https://i.ibb.co/MfzJpDj/user4.png"
                        alt="user"
                      />
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-4">
                    <div>
                      <img
                        height={36}
                        src="https://i.ibb.co/MgT5pCX/user1.png"
                        alt="user"
                      />
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-4">
                    <div>
                      <img
                        height={36}
                        src="https://i.ibb.co/cDH6TyS/user3.png"
                        alt="user"
                      />
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-4">
                    <div>
                      <img
                        height={36}
                        src="https://i.ibb.co/jW3C71d/user2.png"
                        alt="user"
                      />
